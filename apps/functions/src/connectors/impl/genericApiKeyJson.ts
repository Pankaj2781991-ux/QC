import type { Connector, ConnectorConfig, NormalizedExternalData } from '@qc/shared';
import { ApiError } from '../../lib/errors.js';

export class GenericApiKeyJsonConnector implements Connector {
  static readonly type = 'GENERIC_API_KEY_JSON_V1';

  readonly type = GenericApiKeyJsonConnector.type;
  ...
  async fetchStructuredData(input: {
    ...
    if (data && typeof data === 'object' && !Array.isArray(data)) {
      return { kind: 'record', record: data as Record<string, unknown> };
    }
